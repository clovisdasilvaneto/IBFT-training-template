...
function CardImage(props) {
  return <CardImageWrapper src={imgUrl} alt="jairsFace" />;
}
  ...
  return (
    <CardWrapper>
      ...
      <Typography component="p" font="Poppins">
        Você vai encontrar essa resposta e também vai ter um entendimento
        profundo sobre como você, seus pensamentos e suas emoções funcionam.
      </Typography>
    </CardWrapper>
  );
}
